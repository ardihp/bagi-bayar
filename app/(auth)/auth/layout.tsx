...
export default async function AuthLayoutPage({
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-[1fr_minmax(0,768px)_1fr] duration-700 delay-200">
      ...
      <div className="container flex flex-col min-h-[calc(100dvh-132px)] px-4.5 py-5 sm:p-8 lg:p-12 lg:pt-10 md:justify-between gap-6 md:gap-4 border-0! lg:border-x-2!">
        <HeaderAuth />

        <div className="rounded-2xl md:border md:border-secondary/30 md:bg-secondary/5 w-full md:overflow-hidden">
          {children}
        </div>
      </div>
